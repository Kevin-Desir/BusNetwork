...
def calculate_trip_without_stations() :
    next_stations_0 = {
            3: [35, 35],
            2: [42, 42],
            8: [40, 40]
...
if __name__ == "__main__":
    """ This function is executed if executed the test (right click on file > start with debugging) """
    calculate_trip_without_stations()