...
class BusNetworkProcessing(object):
    ...
    def initialize_vector(self, stations, v_list, start_station_id, type_of_search, o_dict):
    ...
    def calculate_trip(self, start_station_id, arrive_station_id, stations, type_of_search):
        ...
        self.initialize_vector(stations, v_list, start_station_id, type_of_search, o_dict)
